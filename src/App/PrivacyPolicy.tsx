...
export const PrivacyPolicy = styled((props: PrivacyPolicyProps) => (
  <div { ...props }>
    ...
    <h3>In summary: We do not track you in any way. We do not share or sell your information. We use the contact information you optionally provide to us to communicate with you and send you information about Trip Emissions.</h3>

    <p>At Trip Emissions, accessible from https://www.trip-emissions.app, https://app.trip-emissions.app, and  https://api.trip-emissions.app, we value the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Trip Emissions and how we use it.</p>

    <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>

    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Trip Emissions. This policy is not applicable to any information collected offline or via channels other than this website.</p>
    ...
    <ul>
      <li>Personalization within the Trip Emissions application</li>
    ...
    <p>The landing page, accessible from https://www.trip-emissions.app, logs no information about visitors.</p>
    <p>The demo application, accessible from https://app.trip-emissions.app, logs no information about visitors.</p>
    <p>The API, accessible from https://api.trip-emissions.app follows standard logging procedures. The information logged includes internet protocol (IP) addresses, browser types (user agents), date and time stamps, and referring/exit pages. These are not linked to any information that is personally identifiable. The purpose of the information is for debugging, security, and keeping the site running.</p>

    <h2>Cookies</h2>

    <p>The landing page, accessible from https://www.trip-emissions.app, uses no cookies.</p>
    <p>The demo application, accessible from https://app.trip-emissions.app, uses a single browser cookie to securely keep you logged in for requests made to the API at https://api.trip-emissions.app.</p>
    ...
    <p>Trip Emissions does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.</p>
  </div>
))`
  width: 100%;
  max-width: 600px;
